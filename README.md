...
- **Zellij Alt passthrough** — when the Zellij backend is selected, the extension contributes terminal-focus-only Alt shortcuts for Zellij's default shared keybindings while keeping VS Code paste and Command Palette handling available
